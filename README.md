# Hướng dẫn Build và Deploy AdminCenter

## Cách triên khai lên admincenter.vinaas.com

1. Sau khi build, và test chạy ổn, thực hiện bước bên dưới:
...
3. push code mới trong /export vào git   https://github.com/vinaas/admincenter_webapp.git

user:  thinnv  hoặc tungpt  hoặc hungnv

## Nội dung bên dưới kế thừa từ trang gôc
